...
@Autonomous(name = "ATags Blue Alliance Blue Terminal", group = "Competition")
public class ATags_Blue_Alliance_Blue_Terminal extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        TrajectorySequence untilCycle = drive.trajectorySequenceBuilder(startPose)
                ...
                .splineToLinearHeading(new Pose2d(61.0,-7,Math.toRadians(0)),Math.toRadians(0))
                .UNSTABLE_addTemporalMarkerOffset(0, clawControl::closeClaw)
                .waitSeconds(0.20)
                .build();
        ...
        TrajectorySequence cycleMid1 = drive.trajectorySequenceBuilder(untilCycle.end())
                ...
                .splineToSplineHeading(new Pose2d(35.5,-15.5,Math.toRadians(225)),Math.toRadians(190))
                .forward(5.5)
                .UNSTABLE_addTemporalMarkerOffset(0.25,()->{clawControl.moveLiftScore(2,75);})
                ...
                .splineToSplineHeading(new Pose2d(61.0,-7,Math.toRadians(0)),Math.toRadians(0))
        ...
        TrajectorySequence cycleMid2 = drive.trajectorySequenceBuilder(cycleMid1.end())
                ...
                .back(4)
                .UNSTABLE_addTemporalMarkerOffset(0.5, clawControl::moveLiftGrab)
                .splineToSplineHeading(new Pose2d(61.0,-7.0,Math.toRadians(0)),Math.toRadians(0))
                .UNSTABLE_addTemporalMarkerOffset(0.35,clawControl::closeClaw)
                .waitSeconds(0.35)
                .back(1)
                .build();
