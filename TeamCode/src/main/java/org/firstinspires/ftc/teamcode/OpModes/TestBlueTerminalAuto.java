...
public class TestBlueTerminalAuto extends LinearOpMode {
    ...
    AutoThreadClass liftControl = new AutoThreadClass(robot,myOpmode);
    public Thread liftThread = new Thread();
    Thread positionThread = new Thread(liftThread);
