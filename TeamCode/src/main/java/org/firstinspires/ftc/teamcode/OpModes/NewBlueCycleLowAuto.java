...
@Autonomous(name = "Fast Blue Low Cycle Auto", group = "Competition")
public class NewBlueCycleLowAuto extends LinearOpMode {
    FtcDashboard dashboard;
    TelemetryPacket dashTelemetry = new TelemetryPacket();
    public static double preloadX = 27;
    public static double preloadY = -29.5;
    ...
    public void runOpMode() {
        ...
        TrajectorySequence cycle1 = drive.trajectorySequenceBuilder(untilCycle.end())
                ...
                .UNSTABLE_addTemporalMarkerOffset(0.125,()->{clawControl.lowerAligner();})
                .UNSTABLE_addTemporalMarkerOffset(0.125,()->{clawControl.moveLiftScore(1);})
                .forward(4)
        ...
        TrajectorySequence cycle2 = drive.trajectorySequenceBuilder(cycle1.end())
                .UNSTABLE_addTemporalMarkerOffset(0,()->{clawControl.moveLiftScore(1,50);})
                ...
                .splineToSplineHeading(new Pose2d(36,-13,Math.toRadians(220)),Math.toRadians(190))
                .forward(6.5)
                .UNSTABLE_addTemporalMarkerOffset(0.5, clawControl::openClaw)
                .waitSeconds(0.5)
                .back(2)
                .UNSTABLE_addTemporalMarkerOffset(0.25, clawControl::moveLiftGrab)
                .splineToSplineHeading(new Pose2d(61.5,-6,Math.toRadians(0)),Math.toRadians(0))
                .UNSTABLE_addTemporalMarkerOffset(0.35,clawControl::closeClaw)
                .waitSeconds(0.35)
                .back(1)
                .build();

        TrajectorySequence cycle3 = drive.trajectorySequenceBuilder(cycle2.end())
                .UNSTABLE_addTemporalMarkerOffset(0,()->{clawControl.moveLiftScore(1,50);})
                //.UNSTABLE_addTemporalMarkerOffset(0.25,()->{clawControl.moveLiftScore(0);})
                .back(12)
                .UNSTABLE_addTemporalMarkerOffset(0.65,()->{clawControl.lowerAligner();})
                ...
                .back(2)
                .UNSTABLE_addTemporalMarkerOffset(0.25, clawControl::moveLiftGrab)
                .splineToSplineHeading(new Pose2d(61,-4,Math.toRadians(0)),Math.toRadians(0))
                .UNSTABLE_addTemporalMarkerOffset(0.35,clawControl::closeClaw)
                .waitSeconds(0.35)
                .back(1)
                .build();

        TrajectorySequence cycle4 = drive.trajectorySequenceBuilder(cycle3.end())
                .UNSTABLE_addTemporalMarkerOffset(0,()->{clawControl.moveLiftScore(1,50);})
                //.UNSTABLE_addTemporalMarkerOffset(0.25,()->{clawControl.moveLiftScore(0);})
                .back(12)
                .UNSTABLE_addTemporalMarkerOffset(0.65,()->{clawControl.lowerAligner();})
        ...
        TrajectorySequence cycle5 = drive.trajectorySequenceBuilder(cycle4.end())
                .UNSTABLE_addTemporalMarkerOffset(0,()->{clawControl.moveLiftScore(1,50);})
                //.UNSTABLE_addTemporalMarkerOffset(0.25,()->{clawControl.moveLiftScore(0);})
                .back(12)
                .UNSTABLE_addTemporalMarkerOffset(0.65,()->{clawControl.lowerAligner();})
        ...
        TrajectorySequence park1 = drive.trajectorySequenceBuilder(cycle5.end())
                .UNSTABLE_addTemporalMarkerOffset(0,()->{clawControl.moveLiftScore(0);})
                .UNSTABLE_addTemporalMarkerOffset(0,clawControl::disableClaw)
                .strafeLeft(24)
                .build();

        TrajectorySequence park3 = drive.trajectorySequenceBuilder(cycle5.end())
                .UNSTABLE_addTemporalMarkerOffset(0,()->{clawControl.moveLiftScore(0);})
                .UNSTABLE_addTemporalMarkerOffset(0,clawControl::disableClaw)
                .strafeRight(24)
                .build();
        ...
        drive.followTrajectorySequence(cycle4);
        drive.followTrajectorySequence(cycle5);
